...
class KingWorksParser:
    ...
    def generate_html_table(self, rows: List[List[str]]) -> str:
        ...
        for row in rows:
            ...
            title_formula = row[3]  # This is in Excel HYPERLINK format
            work_type = row[4]
            collection = row[5]
            ...
            if published_date and published_date not in ['9999-99-99', '0000-00-00']:
                try:
            ...
            table_html.extend([f'<td>{cell}</td>' for cell in row[6:]])
    ...
    <style>
        ...
        * {
        ...
        h1 {
            ...
            text-shadow: 0 0 20px rgba(187, 10, 30, 0.3);
        ...
        .dataTables_wrapper {
            ...
            box-shadow: 0 0 30px rgba(187, 10, 30, 0.05);
        }
        ...
        .dataTables_length select:focus {
            ...
            box-shadow: 0 0 0 3px rgba(187, 10, 30, 0.15);
        }
        ...
        .paginate_button.current {
            ...
            color: var(--text) !important;
            box-shadow: 0 0 15px rgba(187, 10, 30, 0.3);
        }
        ...
        .works-table a:hover {
            color: var(--accent);
            text-shadow: 0 0 10px rgba(255, 31, 61, 0.3);
        }
    ...
    <div class="container">
        <header>
            <div>
                ...
                <div class="subtitle">Complete bibliography and collection details</div>
            </div>
        </header>
        ''' + table_content + '''
    </div>
