...
class KingWorksParser:
    ...
    def generate_html_table(self, rows: List[List[str]]) -> str:
        ...
        for row in rows:
            ...
            # Format the date - display blank if it's '9999-99-99' or '0000-00-00'
            display_date = ""
            sort_date = row[1]
            if row[1] == "0000-00-00":
            ...
            table_html.extend(
                [
                    ...
                    f'<td data-sort="{sort_date}">{display_date}</td>',  # Use data-sort for sorting while displaying blank
